...
function App() {
  ...
  const handleDownloadPDF = () => {
    ...
    const opt = {
      margin: 0,
      filename: 'Camilo_Garcia_EPK.pdf',
    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 mix-blend-difference px-6 py-6 flex justify-between items-center backdrop-blur-sm bg-black/10 print:hidden">
        ...
        <div className="hidden md:flex gap-8 text-[10px] font-bold uppercase tracking-[0.2em]">
          <a href="#bio" className="hover:text-zinc-400 transition-colors">Bio</a>
          <a href="#music" className="hover:text-zinc-400 transition-colors">Música</a>
          <a href="#gallery" className="hover:text-zinc-400 transition-colors">Prensa</a>
          <a href="#rider" className="hover:text-zinc-400 transition-colors">Rider</a>
          <a href="#booking" className="hover:text-zinc-400 transition-colors">Contacto</a>
        </div>
        <Button
          variant="outline"
          ...
          <div className="mt-12 flex flex-col md:flex-row md:items-end justify-between border-t border-zinc-800 pt-8">
            <div className="max-w-xl">
              <p className="text-xl text-zinc-200 font-light leading-snug">
                DJ & Productor. <span className="text-zinc-400">Universal Music, De Konstrut, Oxytech.</span>
              </p>
              <p className="mt-2 text-sm text-zinc-400 font-mono max-w-md">
                Del melodic house al indie dance pasando por el progressive house.
                <br/>Host oficial Moto GP Argentina (2021-2023).
              </p>
            </div>
            
            <div className="mt-8 md:mt-0 flex gap-4">
              <a href="https://open.spotify.com/intl-es/artist/7m1c4h1YmipNM0GwKEkb5H?si=anmD9xUlTWaCvZNwQrEnwg" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-12 h-12 border border-zinc-800 rounded-full hover:bg-white hover:border-white transition-all duration-300">
              ...
              <a href="https://soundcloud.com/camilo-martin-garcia-ii" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-12 h-12 border border-zinc-800 rounded-full hover:bg-white hover:border-white transition-all duration-300">
              ...
              <a href="https://www.instagram.com/camilogarcia1971/" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-12 h-12 border border-zinc-800 rounded-full hover:bg-white hover:border-white transition-all duration-300">
              ...
              <a href="https://drive.google.com/drive/folders/1jq9u3zaHCeVn4YpSjya7drFqus9DqMVM" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-12 h-12 border border-zinc-800 rounded-full hover:bg-white hover:border-white transition-all duration-300">
